...
class PenerimaanRetribusiController extends Controller
{
    ...
    {
        return view("admin.retribusi.penerimaan");
    }
    ...
    {
        $kode_rekening = "Pajak Hiburan";
        $query = DB::table("data.penerimaan_bulanan")->where('nama_rekening',$kode_rekening)->where('tahun',$thn)->orderBy('bulan','ASC')->get();
        // dd($query);
