...
@section('title', 'Detail Penerimaan Harian BPHTB - Smart Dashboard')
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Detail Penerimaan Harian BPHTB</li>
                    </ol>
                </div>
                <div class="col-sm-6">
                </div>
                ...
                <div class="col-xl-12">
                    <div class="card o-hidden">
                        <div class="card-header pb-0">
                            <h6>Detail Penerimaan Harian BPHTB </h6>
                        </div>
                        <div class="card-body">
        ...
        function table_detail_penerimaan_harian() {
            ...
            var table = $(".table-detail-penerimaan-harian").DataTable({
                ...
                buttons: [{
                    ...
                    "titleAttr": 'Excel',
                    "filename": 'Detail Penerimaan Harian BPHTB',
                ...
                searchDelay: 2000,
                ajax: {
                    url: '{{ route('bphtb.penerimaan.datatable_detail_penerimaan_harian') }}',
                    type: 'GET',
                    data: {
                        "tanggal": tanggal
                    }
