...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>Detail Penerimaan Dari Wajib Pajak </h3>
                <ol class="breadcrumb">
            ...
            <div class="col-xl-12">
                <div class="card o-hidden">
                    <div class="card-header pb-0">
                        <h6>Penerimaan dari Wajib Pajak</h6>
                    </div>
                    <div class="card-body">
    ...
    function table_detail(){
       ...
       var table = $(".table-detail").DataTable({
            ...
            buttons: [{
                ...
                "filename": 'Detail Penerimaan dari WP ',
	        ...
	        searchDelay: 2000,
            ajax: {
                url: '{{ route('pbb.tunggakan.datatable_pembayaran_tunggakan_wp') }}',
                type: 'GET',
                data: {
