...
function newexportaction(e, dt, button, config) {
    ...
    function table_detail_tunggakan_nop(){
       ...
       var table = $(".table-detail-tunggakan-nop").DataTable({
	        ...
	        searchDelay: 2000,
            ajax: {
                url: '{{ route('pbb.tunggakan.datatable_detail_tunggakan_nop') }}',
                type: 'GET',
                data: {
                  "tahun":tahun,
                  "wilayah":wilayah,
