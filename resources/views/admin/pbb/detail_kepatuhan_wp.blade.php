...
@section('title', 'Detail Kepatuhan Pajak PBB - Smart Dashboard')
...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>Detail Kepatuhan Pajak</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">PBB</a></li>
                    <li class="breadcrumb-item active">Detail Kepatuhan Pajak</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
    ...
    function table_detail(){
       ...
       var table = $(".table-detail").DataTable({
            ...
            buttons: [{
                ...
                "filename": 'Detail Kepatuhan WP PBB ',
	        ...
	        searchDelay: 2000,
            ajax: {
                url: '{{ route('pbb.op.datatable_detail_kepatuhan_wp') }}',
                type: 'GET',
                data: {
                  "tahun":tahun,
                  "kecamatan":kecamatan,
