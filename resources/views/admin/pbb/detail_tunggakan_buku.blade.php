...
function newexportaction(e, dt, button, config) {
    ...
    function table_detail_tunggakan_buku(){
       ...
       var table = $(".table-detail-tunggakan-nop").DataTable({
        dom: "<'row'<'col-sm-12 col-md-3'l><'col-sm-12 col-md-6 text-center'B><'col-sm-12 col-md-3'>>" +
            ...
            buttons: [{
                ...
                "filename": 'Detail Tunggakan Buku PBB',
	        ...
	        searchDelay: 2000,
            ajax: {
                url: '{{ route('pbb.tunggakan.datatable_detail_tunggakan_buku') }}',
                type: 'GET',
                data: {
                  "buku":buku,
                  "tahun":tahun,
