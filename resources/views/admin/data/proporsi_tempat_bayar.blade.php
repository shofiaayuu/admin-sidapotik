...
@section('title', 'Proporsi Tempat Pembayaran - Smart Dashboard')
...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>Proporsi Tempat Pembayaran</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Daftar Data</a></li>
                    <li class="breadcrumb-item active">Proporsi Tempat Pembayaran</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
...
<script>
    ...
    function Datatable(){
       var table = $(".datatable").DataTable({
	        ...
	        responsive: true,
	        searchDelay: 2000,
	        ajax: '{{ route('data.datatable_proporsi_tempat_bayar') }}',
	        columns: [
                ...
                {data: 'persen_jumlah', name: 'persen_jumlah'},
