...
@section('title', 'Keberatan Permohonan BPHTB - Smart Dashboard')
...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>Keberatan Permohonan BPHTB</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Daftar Data</a></li>
                    <li class="breadcrumb-item active">Keberatan Permohonan BPHTB</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
...
<script>
    ...
    function Datatable(){
       var table = $(".datatable").DataTable({
	        ...
	        responsive: true,
	        searchDelay: 2000,
	        ajax: '{{ route('data.datatable_keberatan_bphtb') }}',
	        columns: [
	            ...
	            {data: 'nominal_penelitian', name: 'nominal_penelitian'},
                {data: 'nominal_ketetapan', name: 'nominal_ketetapan'},
                {data: 'nominal_selisih', name: 'nominal_selisih'},
