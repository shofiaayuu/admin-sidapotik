...
@section('title', 'Penerimaan per Bulan - Smart Dashboard')
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Penerimaan per Bulan</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
...
<script>
    ...
    function Datatable(){
       var table = $(".datatable").DataTable({
	        ...
	        responsive: true,
	        searchDelay: 2000,
	        ajax: '{{ route('data.datatable_penerimaan_per_bulan') }}',
	        columns: [
