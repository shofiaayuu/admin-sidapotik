...
@section('title', 'Rekap Ketetapan BPHTB Validasi - Smart Dashboard')
...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>Rekap Ketetapan BPHTB Validasi</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Daftar Data</a></li>
                    <li class="breadcrumb-item active">Rekap Ketetapan BPHTB Validasi</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
...
<script>
    ...
    function Datatable(){
       var table = $(".datatable").DataTable({
	        ...
	        responsive: true,
	        searchDelay: 2000,
	        ajax: '{{ route('data.datatable_rekap_ketetapan_bphtb_validasi') }}',
	        columns: [
                ...
                {data: 'jumlah_ketetapan', name: 'jumlah_ketetapan'},
                {data: 'sudah_divalidasi', name: 'sudah_divalidasi'},
	            {data: 'belum_divalidasi', name: 'belum_divalidasi'},
