        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Daftar Sektor UMKM</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
                ...
                <div class="card o-hidden">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center gap-2 mb-2">
                            <label for="" style="font-size: 20px;font-weight: bold;">Tabel Daftar Sektor UMKM</label>
                ...
                <div class="modal-body">
                    <div class="container-fluid" style="font-size: 17px;font-weight: 600;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nilai_aset" name="nilai_aset" placeholder="Input Nilai Aset">
                        </div>
                        <div class="form-group">
                            <label for="bidang_usaha">Bidang Usaha</label>
                            <input type="text" class="form-control" id="bidang_usaha" name="bidang_usaha" placeholder="Input Bidang Usaha">
                        </div>
                        <div class="form-group">
                            <label for="kapasitas_produksi">Kapasitas Produksi</label>
                            <input type="text" class="form-control" id="kapasitas_produksi" name="kapasitas_produksi" placeholder="Input Kapasitas Produksi">
                        </div>
                        <div class="form-group">
                            <label for="biaya_investasi">Tenaga Kerja</label>
                            <input type="text" class="form-control" id="biaya_investasi" name="biaya_investasi" placeholder="Input Tenaga Kerja">
                        </div>
                        <div class="form-group">
                            <label for="pimpinan">Pimpinan</label>
                            <input type="text" class="form-control" id="pimpinan" name="pimpinan" placeholder="Input Pimpinan">
                        </div>
                        <div class="form-group">
                            <label for="no_telp">No Telepon</label>
                            <input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="Input No Telepon">
                        </div>
                        <div class="form-group">
...
<script>
    ...
    $(document).ready(function(){
        $('#closeModalBtn, #closeModal').click(function(){
            window.location.href = '{{ route("data.sektor_umkm") }}';
        });
    });
