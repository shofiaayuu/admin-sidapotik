...
@section('title', 'Jumlah Objek Retribusi - Smart Dashboard')
...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>Jumlah Objek Retribusi</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Daftar Data</a></li>
                    <li class="breadcrumb-item active">Jumlah Objek Retribusi</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
...
<script>
    ...
    function Datatable(){
       var table = $(".datatable").DataTable({
	        ...
	        responsive: true,
	        searchDelay: 2000,
	        ajax: '{{ route('data.datatable_jumlah_objek_retribusi') }}',
	        columns: [
