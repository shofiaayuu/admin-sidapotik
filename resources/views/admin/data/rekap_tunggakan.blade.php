...
@section('title', 'Rekapitulasi Tunggakan - Smart Dashboard')
...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>Rekapitulasi Tunggakan</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Daftar Data</a></li>
                    <li class="breadcrumb-item active">Rekapitulasi Tunggakan</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
...
<script>
    ...
    function Datatable(){
       var table = $(".datatable").DataTable({
	        ...
	        responsive: true,
	        searchDelay: 2000,
	        ajax: '{{ route('data.datatable_rekap_tunggakan') }}',
	        columns: [
